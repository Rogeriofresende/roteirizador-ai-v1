...
describe('geminiService', () => {
  ...
  describe('generateScript', () => {
    ...
    it('gera roteiro com sucesso', async () => {
      ...
      (window.localStorage.getItem as Mock).mockReturnValue('fake-api-key');
    ...
    it('solicita API key quando não existe', async () => {
      ...
      (window.prompt as Mock).mockReturnValue('new-api-key');
  ...
  describe('getApiKeyFromUser', () => {
    it('obtém nova API key do usuário', () => {
      (window.prompt as Mock).mockReturnValue('user-provided-key');
    ...
    it('salva API key no localStorage', () => {
      (window.prompt as Mock).mockReturnValue('new-key');
