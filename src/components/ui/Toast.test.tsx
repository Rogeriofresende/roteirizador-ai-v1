  ...
  describe('🎯 Múltiplos Toasts', () => {
    it('deve suportar múltiplos toasts simultaneamente', () => {
      const { rerender } = render(
        <div>
          <MockToast message="Toast 1" onClose={vi.fn()} />
        </div>
      );
      ...
      rerender(
        <div>
          <MockToast message="Toast 1" onClose={vi.fn()} />
          <MockToast message="Toast 2" type="success" onClose={vi.fn()} />
          <MockToast message="Toast 3" type="error" onClose={vi.fn()} />
        </div>
      );
