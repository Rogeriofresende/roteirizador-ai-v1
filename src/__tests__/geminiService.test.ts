...
import { generateScript, validateApiKey, getApiKeyFromUser } from '../services/geminiService';
...
const mockGoogleGenerativeAI = GoogleGenerativeAI as jest.MockedFunction<typeof 
